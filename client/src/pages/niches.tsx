...
const allNiches = [
  ...
  { id: 8, name: "Commercial Photography", icon: Camera, category: "Photography & Videography", available: true, slug: "commercial-photography", description: "E-commerce and catalog product photography" },
  ...
  { id: 14, name: "Painting & Decorating", icon: Paintbrush, category: "Home Services", available: true, slug: "painting-decorating", description: "Interior and exterior painting and decorating services" },
